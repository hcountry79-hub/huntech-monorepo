...
window.TROUT_WATERS = [
  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    description: 'Ozark National Scenic Riverway — Missouri\'s premier trophy brown trout river. Blue Ribbon zones from Park End to Cedar Grove hold wild brown trout in gin-clear, spring-fed water. Stocked rainbows from Montauk Spring add diversity. 18" minimum, 1 fish limit. Sculpin, crayfish, and classic Ozark hatches fuel trophy growth. Same check-in flow as Montauk — hotspot pins deploy across all 4 Blue Ribbon zones.'
  },
  {
