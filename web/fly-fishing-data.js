...
window.TROUT_WATERS = [
  ...
  // ═══════════════════════════════════════════════════════════════════════
  {
    ...
    access: [
      ...
      // Boundaries user-verified 2026-02-26 from field GPS coordinates (DMS → decimal)
      // zoneBounds: [[upstream lat,lng], [downstream lat,lng]]
      // Park End / Blue Ribbon Start:  37°26'59.33"N 91°40'16.92"W = 37.44981, -91.67137
      // Tan Vat upstream boundary:     37°26'48.76"N 91°39'56.47"W = 37.44688, -91.66569
      // Tan Vat center:                37°27'03.66"N 91°39'41.78"W = 37.45102, -91.66161
      // Tan Vat / Baptist Camp split:  37°26'35.64"N 91°39'21.83"W = 37.44323, -91.65606
      // Baptist Camp center:           37°26'07.42"N 91°39'25.70"W = 37.43539, -91.65714
      // Baptist Camp / Cedar Grove:    37°25'53.27"N 91°37'50.54"W = 37.43146, -91.63071
      // Cedar Grove center:            37°25'20.22"N 91°36'30.53"W = 37.42228, -91.60848
      // Cedar Grove downstream end:    37°24'51.42"N 91°36'23.40"W = 37.41428, -91.60650
      { name: 'Blue Ribbon — Park Boundary Headwaters', lat: 37.44981, lng: -91.67137, type: 'zone', zoneId: 'park-boundary', methods: ['fly', 'spin'], zoneBounds: [[37.44981, -91.67137], [37.44688, -91.66569]], habitat: 'riffle-run-pool', clarity: 'gin-clear', depth: 'medium-deep', pressure: 'moderate', notes: 'Park boundary headwaters to Tan Vat. Blue Ribbon water — flies and artificial lures only, 1 fish, 18" min. TROPHY BROWN TROUT WATER. Cold, gin-clear spring-fed flow holds both stocked rainbows drifting from Montauk Spring and wild brown trout that ambush from undercut banks and boulder shadows. Highest trout density on the Current. Dawn and dusk are prime for big browns.' },
      { name: 'Blue Ribbon — Tan Vat', lat: 37.45102, lng: -91.66161, type: 'zone', zoneId: 'tan-vat', methods: ['fly', 'spin'], zoneBounds: [[37.44688, -91.66569], [37.44323, -91.65606]], habitat: 'run-pool', clarity: 'clear', depth: 'medium', pressure: 'low', notes: 'Tan Vat to Baptist Camp. Blue Ribbon water. PREMIER TROPHY BROWN TROUT REACH. Wild browns hold in deep pools, spring seeps, and under log jams. Stocked rainbows migrate down from Montauk. Cold spring inflows create thermal refuges where big browns stack up year-round. Excellent solitude — remote gravel road access only. Best wild brown trout water on the main Current.' },
      { name: 'Blue Ribbon — Baptist Camp', lat: 37.43539, lng: -91.65714, type: 'zone', zoneId: 'baptist-camp', methods: ['fly', 'spin'], zoneBounds: [[37.44323, -91.65606], [37.43146, -91.63071]], habitat: 'riffle-run', clarity: 'clear', depth: 'medium', pressure: 'low', notes: 'Baptist Camp to Cedar Grove upper. Blue Ribbon water. Trophy brown trout country. Wild browns patrol deep runs and undercut ledges. Spring seeps along banks create cold-water sanctuaries. Sculpin and crayfish populations fuel trophy growth.' },
      { name: 'Blue Ribbon — Cedar Grove', lat: 37.42228, lng: -91.60848, type: 'zone', zoneId: 'cedar-grove', methods: ['fly', 'spin'], zoneBounds: [[37.43146, -91.63071], [37.41428, -91.60650]], habitat: 'riffle-run', clarity: 'clear', depth: 'medium', pressure: 'low', notes: 'Cedar Grove lower reach. Blue Ribbon water. REMOTE trophy brown trout country. Wild browns patrol deep runs and undercut ledges. Gravel bar camping. True backcountry solitude. Low pressure means big, educated browns.' },
      { name: 'Reach 4 — Welch Spring Corridor (Cedar Grove → Akers)', lat: 37.3785, lng: -91.5620, type: 'zone', methods: ['fly', 'spin', 'bait'], zoneBounds: [[37.41428, -91.60650], [37.3440, -91.4960]], habitat: 'riffle-run', clarity: 'clear', depth: 'medium', pressure: 'low', notes: 'Cedar Grove to Akers Ferry. Welch Spring (121 cfs) enters mid-reach — its spring branch holds wild trout. Main river has mixed trout and smallmouth. Float-fishing territory. Remote and beautiful.' },
      ...
      { name: 'Tan Vat Access', lat: 37.44688, lng: -91.66569, type: 'entry', verified: true, notes: 'Blue Ribbon — Tan Vat upstream boundary. Downstream of Montauk via CR 119. Named for old tanning vat. Gravel road. Wild trout in spring branches.' },
      { name: 'Baptist Camp', lat: 37.44323, lng: -91.65606, type: 'entry', verified: true, notes: 'Blue Ribbon — Baptist Camp upstream boundary (Tan Vat/Baptist Camp split). Walk-in access. Deeper pools, quieter water. Some private land — check signs.' },
      { name: 'Cedar Grove', lat: 37.43146, lng: -91.63071, type: 'entry', verified: true, notes: 'Blue Ribbon — Cedar Grove upstream boundary (Baptist Camp/Cedar Grove split). Remote access. Excellent solitude and wild trout. Gravel bar camping.' },
    ...
    // ── Hotspot Holding Areas — Blue Ribbon Trophy Brown Trout Zone ──
    // OSM Way 162645228 — all coordinates from real streamPath nodes, verified 2026-02-26
    // Geometric analysis of 387 nodes: bearing changes, curvature windows, S-curve detection
    // Each hotspot tagged with zoneId — only deploys when that zone is checked in
    hotspots: [

      // ═══ PARK BOUNDARY — 6 hotspots (nodes 0–20, 1013m) ═══
      // Short zone just below Montauk. Holdover rainbows + wild browns. Spring-fed cold water.
      { name: 'Park Entry Riffle', lat: 37.44885, lng: -91.67109, habitat: 'riffle', zoneId: 'park-boundary', notes: 'Fast shallow riffle at the Blue Ribbon boundary (node 2, 95m). Broken water over gravel — holdover rainbows from Montauk stack here with wild browns behind boulders. Dead-drift a Pheasant Tail or Hare\'s Ear nymph. Forgiving water for sight-nymphing.' },
      { name: 'Park Entrance Seam', lat: 37.44826, lng: -91.67113, habitat: 'seam', zoneId: 'park-boundary', notes: 'Current seam where the river\'s first S-curve creates converging flows (node 4, 169m). 88° direction change. Trout line up along the speed differential feeding on drifting nymphs. Dry-dropper rigs excel — visible dry on top, nymph 18" below.' },
      { name: 'First Bend Pool', lat: 37.44628, lng: -91.67109, habitat: 'pool', zoneId: 'park-boundary', notes: 'Deep outside-bend pool at the first significant left curve (node 9, 413m). 80° bearing change pushes current against the far bank, scouring a deep slot. Wild browns hold tight to the undercut. Roll-cast streamers along the outside bank at dawn.' },
      { name: 'Park Descent Run', lat: 37.44567, lng: -91.66972, habitat: 'run', zoneId: 'park-boundary', notes: 'Steep-gradient run as the river drops southeast (node 12, 544m). Moderate depth with consistent current and good dissolved oxygen. Both species cruise this water. Swing soft hackles or dead-drift a scud pattern through the main channel.' },
      { name: 'Park Horseshoe Pool', lat: 37.44515, lng: -91.66822, habitat: 'pool', zoneId: 'park-boundary', notes: 'Deep bend pool at the big 82° left horseshoe curve (node 15, 690m). The deepest holding water in the Park Boundary zone. Trophy browns stack here year-round, especially in the thermal layer near any spring seeps. Strip a Woolly Bugger along the far bank or dead-drift a scud.' },
      { name: 'Park Exit Tailout', lat: 37.44582, lng: -91.66699, habitat: 'tailout', zoneId: 'park-boundary', notes: 'Broad tailout as the horseshoe pool shallows before entering Tan Vat water (node 18, 825m). 85° transition zone — shallowing gravel where emergers concentrate at dusk. Big browns push up from the pool to feed on hatching insects. Evening dry fly water — BWOs and midges.' },

      // ═══ TAN VAT — 9 hotspots (nodes 20–56, 1549m) ═══
      // River makes a big northward oxbow loop then sweeps back south. Named for old tanning vat.
      // Undercut limestone ledges, wild browns, some holdover rainbows.
      { name: 'Tan Vat Entry Run', lat: 37.44773, lng: -91.66458, habitat: 'run', zoneId: 'tan-vat', notes: 'Smooth run entering the Tan Vat oxbow from the northeast (node 22, 1131m). Steady current over mixed gravel and cobble. Fish cruise this water picking off nymphs and emergers. Dry-dropper or indicator nymph rig — mend upstream for drag-free drifts.' },
      { name: 'Oxbow Riffle', lat: 37.44866, lng: -91.66351, habitat: 'riffle', zoneId: 'tan-vat', notes: 'Productive riffle on the ascending limb of the Tan Vat oxbow (node 25, 1272m). Broken water over clean gravel — an oxygen factory where trout feed aggressively during hatches. Short leader with weighted nymphs. Watch for subtle emerger rises in the tail.' },
      { name: 'Tan Vat Apex Pool', lat: 37.45043, lng: -91.66151, habitat: 'pool', zoneId: 'tan-vat', notes: 'Deep pool at the northernmost apex of the oxbow (node 34, 1548m). 54° right bend pushes current against the outside bank forming the deepest water in the zone. Trophy browns hold near the bottom. Bounce a weighted sculpin or crayfish pattern along the ledge face.' },
      { name: 'North Loop Bend', lat: 37.45051, lng: -91.66109, habitat: 'pool', zoneId: 'tan-vat', notes: 'Second bend pool where the oxbow begins curving back south (node 37, 1620m). 69° right curve with deep outside water and a gravel bar on the inside. Browns ambush from the depth break. Czech nymph tight to the bottom or swing a soft hackle through the tail.' },
      { name: 'Switchback Seam', lat: 37.44975, lng: -91.65986, habitat: 'seam', zoneId: 'tan-vat', notes: 'High-energy seam where the oxbow reverses direction (node 42, 1731m). 61° of converging current lines create a prime feeding lane. Trout hold in the slower water and dart into the seam for food. Precise dead-drifts with a Pheasant Tail or Copper John right along the speed break.' },
      { name: 'Tan Vat South Bend', lat: 37.44906, lng: -91.65889, habitat: 'pool', zoneId: 'tan-vat', notes: 'Left-bend pool as the river sweeps back southward (node 44, 1847m). 57° bearing change with undercut limestone on the outside. Wild browns use the undercut as ambush cover. Low-profile approach — roll-cast a streamer tight to the rock face at first and last light.' },
      { name: 'Lower Chute Riffle', lat: 37.44845, lng: -91.65778, habitat: 'riffle', zoneId: 'tan-vat', notes: 'Fast chute riffle between bends (node 46, 1938m). Broken, well-oxygenated water over gravel. Excellent hatch water — both BWOs and caddis emerge here in numbers. Short dead-drifts with an indicator or dry-dropper. Watch for trout feeding in the film.' },
      { name: 'Undercut Ledge Pool', lat: 37.44732, lng: -91.65691, habitat: 'pool', zoneId: 'tan-vat', notes: 'Deep bend pool with undercut limestone ledges (node 51, 2121m). 79° right bend — the biggest curve in Tan Vat. Trophy browns hold under the overhanging rock. Swing streamers or bounce a weighted sculpin along the ledge face. Prime low-light ambush water.' },
      { name: 'Tan Vat Exit Run', lat: 37.44449, lng: -91.65597, habitat: 'run', zoneId: 'tan-vat', notes: 'Long southward run as the river straightens above Baptist Camp (node 54, 2322m). Steady moderate current over mixed substrate. Fish cruise and feed throughout the water column. Indicator nymphing or Euro-style tight-line techniques work well. Good prospecting water.' },

      // ═══ BAPTIST CAMP — 24 hotspots (nodes 56–285, 7208m) ═══
      // Longest zone — increasingly remote. Multiple dramatic S-curves and oxbows.
      // Best wild brown trout habitat on the Blue Ribbon. Deeper pools, complex structure.
      { name: 'Baptist Entry Run', lat: 37.44235, lng: -91.65588, habitat: 'run', zoneId: 'baptist-camp', notes: 'Moderate run at the Baptist Camp upstream boundary (node 59, 2600m). Steady southward flow over mixed gravel. Both species cruise this water. A good warm-up section — indicator nymph rig with a Hare\'s Ear and Pheasant Tail dropper.' },
      { name: 'South Straightaway Riffle', lat: 37.43678, lng: -91.65744, habitat: 'riffle', zoneId: 'baptist-camp', notes: 'Long productive riffle through the first southward straightaway (node 68, 3333m). Broken water over clean gravel — classic hatch water. During BWO and caddis emergences, trout feed aggressively in the film. Match the hatch with dries or swing soft hackles through the tail.' },
      { name: 'First Oxbow Pool', lat: 37.43504, lng: -91.65743, habitat: 'pool', zoneId: 'baptist-camp', notes: 'Deep bend pool at the first major 99° left curve (node 73, 3529m). The river abruptly changes from heading south to heading east — the outside bend scours a deep slot against the far bank. Big browns hold in the depth. Dead-drift a heavy nymph along the seam or strip streamers at dawn.' },
      { name: 'Switchback Deep Pool', lat: 37.43472, lng: -91.65578, habitat: 'pool', zoneId: 'baptist-camp', notes: 'Massive 169° switchback bend — nearly a U-turn (node 77, 3718m). One of the deepest pools on the Blue Ribbon. The extreme curvature scours bedrock to create a profound holding lie. Trophy browns stack here. Weighted sculpin patterns bounced along the bottom or slow-stripped Woolly Buggers.' },
      { name: 'Post-Switchback Seam', lat: 37.43575, lng: -91.65403, habitat: 'seam', zoneId: 'baptist-camp', notes: 'Complex seam below the switchback where opposing currents converge (node 82, 3914m). 99° of converging flow lines. Trout hold in the calmer water at the seam edge and intercept food from both current lanes. Precise presentations with a dry-dropper — dead-drift right along the speed break.' },
      { name: 'Oxbow Riffle Run', lat: 37.43660, lng: -91.65275, habitat: 'riffle', zoneId: 'baptist-camp', notes: 'Productive riffle section on the ascending limb of the mid-zone oxbow (node 87, 4050m). Good gradient over gravel creates well-oxygenated feeding water. Both browns and rainbows work this water during hatches. Short-line nymphing or Euro techniques are deadly here.' },
      { name: 'S-Curve Pool', lat: 37.43749, lng: -91.65022, habitat: 'pool', zoneId: 'baptist-camp', notes: 'Deep pool at a dramatic 156° left bend (node 98, 4335m). The river nearly reverses direction — extreme curvature scours a deep holding lie on the outside. Trophy brown trout water. Slow-strip a Muddler Minnow or dead-drift a weighted crayfish pattern along the outside ledge.' },
      { name: 'Horseshoe Bend Pool', lat: 37.43838, lng: -91.64984, habitat: 'pool', zoneId: 'baptist-camp', notes: 'THE biggest bend on the entire Blue Ribbon — 173° right curve (node 106, 4476m). Near-complete reversal creates an enormously deep, slow pool on the outside. The apex predator lie on this river. Trophy browns of 20"+ hold here. Streamers at dawn/dusk, heavy nymphs midday. Patient, stealthy approach essential.' },
      { name: 'Mid-Zone Run', lat: 37.43700, lng: -91.64760, habitat: 'run', zoneId: 'baptist-camp', notes: 'Steady run through the center of the upper Baptist Camp reach (node 113, 4640m). Moderate depth and consistent current — classic prospecting water. Fish the whole water column with a dry-dropper or indicator rig. Look for feeding lanes along subtle current seams.' },
      { name: 'Bluff Bend Pool', lat: 37.43380, lng: -91.64716, habitat: 'pool', zoneId: 'baptist-camp', notes: 'Right-bend pool where the river curves against a limestone bluff (node 126, 5125m). 59° bearing change pushes current against the rock face. Browns hold tight to the bluff in the shade. Bounce nymphs along the rock or swing streamers past the undercut. Good structure fishing.' },
      { name: 'Bluff Seam', lat: 37.43279, lng: -91.64793, habitat: 'seam', zoneId: 'baptist-camp', notes: 'Strong seam line below the bluff bend (node 130, 5264m). 78° of converging flow where fast riffle water meets the slower pool outflow. Trout stack along this seam feeding on nymphs and emergers. Dead-drift a Pheasant Tail right in the speed break — subtle takes, watch your indicator closely.' },
      { name: 'Ledge Pool', lat: 37.43152, lng: -91.64877, habitat: 'pool', zoneId: 'baptist-camp', notes: 'Deep pool at a major 121° left bend with exposed bedrock ledges (node 135, 5430m). The ledge creates a sharp depth break — fish hold in the ledge shadow and ambush prey. Weighted Sculpin Zonkers and crayfish patterns fished tight to the rock are deadly. Prime big brown water.' },
      { name: 'Double Bend Pool', lat: 37.43075, lng: -91.64780, habitat: 'pool', zoneId: 'baptist-camp', notes: 'Massive 160° right-bend pool — another near-reversal (node 143, 5582m). Back-to-back with the Ledge Pool above to form a complex of deep holding water. The combined depth and structure make this stretch some of the best trophy water on the river. Streamers, heavy nymphs, patience.' },
      { name: 'Baptist Mid Riffle', lat: 37.42909, lng: -91.64967, habitat: 'riffle', zoneId: 'baptist-camp', notes: 'Classic riffle between the Double Bend and lower Baptist Camp pools (node 149, 5836m). Both species feed aggressively during hatches. Browns hold in deeper slots between gravel bars. Match the hatch with dries or swing soft hackles — productive all day during emergences.' },
      { name: 'Limestone Bend Pool', lat: 37.42672, lng: -91.65026, habitat: 'pool', zoneId: 'baptist-camp', notes: 'Left-bend pool against limestone at a 56° curve (node 157, 6114m). Moderate depth with undercut bank structure on the outside. Browns tuck under the rock during bright conditions. Roll-cast a streamer tight to the bank at first light, switch to nymphs as sun hits the water.' },
      { name: 'Undercut Pool', lat: 37.42489, lng: -91.64983, habitat: 'pool', zoneId: 'baptist-camp', notes: 'Deep 87° left-bend pool with undercut limestone (node 162, 6331m). The aggressive curvature carves deep holding water against the outside bank. Trophy browns use the undercut for shade and ambush cover. Low-light streamer fishing or weighted Czech nymphs tight to the ledge.' },
      { name: 'Gravel Bar Tailout', lat: 37.42329, lng: -91.64745, habitat: 'tailout', zoneId: 'baptist-camp', notes: 'Broad tailout where the Undercut Pool shallows over gravel (node 173, 6636m). Classic evening water — big browns push up from the pool at dusk to feed on emergers and spinners. BWO spinner falls and caddis egg-laying flights trigger aggressive surface feeding. Stand back and cast long.' },
      { name: 'Convergence Seam', lat: 37.42121, lng: -91.64558, habitat: 'seam', zoneId: 'baptist-camp', notes: 'Strong double seam where back-to-back S-curves create converging flow lines (node 183, 6928m). 81° of conflicting currents. Trout stack where the fast water meets the slow — a natural food funnel. Precise presentations required. Tight-line Euro nymphing excels here.' },
      { name: 'Deep Oxbow Pool', lat: 37.42026, lng: -91.64476, habitat: 'pool', zoneId: 'baptist-camp', notes: 'Deep 101° left-bend pool in a pronounced oxbow (node 188, 7070m). Heavy curvature scours a deep hole on the outside. Trophy browns hold in the depth, especially during summer heat when they seek cold-water thermal refuges. Weighted streamers and indicator-nymph rigs probing the bottom.' },
      { name: 'Gorge Pool', lat: 37.42144, lng: -91.64190, habitat: 'pool', zoneId: 'baptist-camp', notes: 'Deep pool at a 92° left bend where the river cuts through a narrow gorge (node 198, 7380m). Constrained flow creates deep, powerful water. Big browns hold in the hydraulic cushion. Heavy nymph rigs or sinking-tip streamers get down to fish level. Challenging but rewarding water.' },
      { name: 'Counter-Bend Pool', lat: 37.42395, lng: -91.64165, habitat: 'pool', zoneId: 'baptist-camp', notes: 'Dramatic 111° left-bend pool where the river reverses from the Gorge section (node 212, 7676m). A complex eddy system forms on the inside bend. Trophy browns patrol the depth break between fast and slow water. Swing streamers through the transition zone or dead-drift heavy nymphs.' },
      { name: 'S-Curve Seam', lat: 37.42540, lng: -91.64346, habitat: 'seam', zoneId: 'baptist-camp', notes: 'Powerful seam line in a tight S-curve complex (node 222, 7924m). 106° of alternating current direction. Where fast rip-rap water meets the calmer eddy — trout hold along the speed break and dart into the seam. Dry-dropper rigs or indicator nymphing right along the speed differential.' },
      { name: 'Trophy Bend Pool', lat: 37.42618, lng: -91.64429, habitat: 'pool', zoneId: 'baptist-camp', notes: 'Large 101° right-bend pool with deep holding water (node 226, 8042m). The aggressive curvature carves a deep outside slot where the biggest browns in the mid-reach hold. Prime trophy water — approach low and slow. Streamers at dawn, heavy nymphs through the middle of the day.' },
      { name: 'Ledge Run', lat: 37.42831, lng: -91.64150, habitat: 'run', zoneId: 'baptist-camp', notes: 'Long bedrock ledge run through a straight reach (node 240, 8422m). 84° curvature with exposed ledge creating depth variation. Browns hunt sculpin and crayfish along the ledge face. Weighted Muddler Minnow or Sculpin Zonker drifted tight to the rock. Consistent producing water.' },
      { name: 'Lower Bend Pool', lat: 37.42759, lng: -91.63548, habitat: 'pool', zoneId: 'baptist-camp', notes: 'Sharp 121° left-bend pool in the lower Baptist Camp reach (node 261, 8996m). Deep outside water against rock structure. Increasingly remote — lower fishing pressure means bigger, less-spooked fish. Heavy nymph rigs or sinking streamers along the outside bank.' },
      { name: 'Lower S-Curve Pool', lat: 37.42814, lng: -91.63348, habitat: 'pool', zoneId: 'baptist-camp', notes: 'Right-bend pool in a complex S-curve (node 269, 9249m). 99° curvature with deep outside holding water. Trophy browns patrol the depth break. Part of a continuous series of bends — fish the outside seam of each curve. Streamers, Woolly Buggers, or heavy Czech nymphs.' },
      { name: 'Baptist Exit Pool', lat: 37.42824, lng: -91.63180, habitat: 'pool', zoneId: 'baptist-camp', notes: 'Deep 106° left-bend pool near the Baptist Camp/Cedar Grove boundary (node 277, 9416m). The last major pool before Cedar Grove. Big browns hold here year-round. The depth and structure make it a reliable producer. Fish it carefully — these are educated, wild fish. Low-profile approach.' },

      // ═══ CEDAR GROVE — 14 hotspots (nodes 285–384, 4116m) ═══
      // Most remote section. Trophy brown trout country. Gravel bar camping.
      // Low pressure, big educated fish. True backcountry solitude.
      { name: 'Cedar Entry Bend', lat: 37.43259, lng: -91.62990, habitat: 'pool', zoneId: 'cedar-grove', notes: 'Deep 95° left-bend pool at the Cedar Grove upstream boundary (node 288, 9933m). Marks the transition to remote backcountry water. Trophy browns hold in the depth. Fish pressure drops dramatically from here downstream. Strip streamers at dawn or dead-drift scuds and crayfish patterns.' },
      { name: 'Cedar S-Curve Seam', lat: 37.43328, lng: -91.63035, habitat: 'seam', zoneId: 'cedar-grove', notes: 'Massive 155° seam where a dramatic S-curve creates powerful converging currents (node 291, 10025m). One of the strongest seam lines on the river. Trout stack along the speed break. Precise presentations with tight-line Euro nymphing or a carefully mended indicator rig. Worth extended fishing time.' },
      { name: 'North Oxbow Pool', lat: 37.43648, lng: -91.63048, habitat: 'pool', zoneId: 'cedar-grove', notes: 'Deep pool at an 86° right bend in the Cedar Grove northward oxbow (node 302, 10405m). Current pushes against the outside bank, scouring deep holding water. Wild browns ambush from the depth break. Bounce weighted nymphs along the outside seam or swing streamers through the tail.' },
      { name: 'Cedar Riffle', lat: 37.43738, lng: -91.62791, habitat: 'riffle', zoneId: 'cedar-grove', notes: 'Well-oxygenated riffle in the upper Cedar Grove reach (node 310, 10658m). Clean gravel substrate — excellent insect production. Good hatch water during BWO and caddis emergences. Both wild browns and rainbow holdovers feed here. Short-line nymphing or dry-dropper through the filmiest sections.' },
      { name: 'Long Pool', lat: 37.43780, lng: -91.62452, habitat: 'pool', zoneId: 'cedar-grove', notes: 'Extended pool through a gentle 46° right bend (node 317, 10965m). Moderate depth over a long stretch — fish cruise and hold throughout. Good prospecting water for covering ground. Indicator nymphing or Euro tight-line techniques. Work the run systematically, covering all the water.' },
      { name: 'Mid-Cedar Bend', lat: 37.43654, lng: -91.62091, habitat: 'pool', zoneId: 'cedar-grove', notes: 'Left-bend pool in the mid-Cedar Grove section (node 327, 11327m). 48° curve with depth on the outside. Remote water with very low pressure — wild browns are less spooked but highly selective. Match the hatch precisely. Small BWOs, midges, and scuds are reliable producers year-round.' },
      { name: 'Big Horseshoe Pool', lat: 37.43679, lng: -91.61925, habitat: 'pool', zoneId: 'cedar-grove', notes: 'The biggest bend in Cedar Grove — 132° right curve (node 334, 11504m). Dramatic curvature carves the deepest holding water in the zone. Apex predator lies. Trophy browns of 20"+ hold here. Patient, stealthy approach. Streamers at dawn/dusk, weighted crayfish and sculpin patterns midday.' },
      { name: 'Horseshoe Seam', lat: 37.43599, lng: -91.61846, habitat: 'seam', zoneId: 'cedar-grove', notes: 'Strong seam below the Big Horseshoe where fast tailout water meets the calmer pool inflow (node 337, 11619m). 76° of converging currents. Trout hold right at the speed break. Dry-dropper rigs work well — visible dry on top for tracking, nymph at fish level below. Precise drift control essential.' },
      { name: 'Cedar Lower Bend', lat: 37.43503, lng: -91.61730, habitat: 'pool', zoneId: 'cedar-grove', notes: 'Left-bend pool below the Horseshoe complex (node 341, 11773m). 57° curve with moderate depth. Part of the continuous deep water extending from the Big Horseshoe. Fish the outside seam with weighted nymphs. Browns that get pushed from the Horseshoe often hold here instead.' },
      { name: 'Gravel Bar Pool', lat: 37.43312, lng: -91.61491, habitat: 'pool', zoneId: 'cedar-grove', notes: 'Right-bend pool with an exposed gravel bar on the inside (node 348, 12082m). 70° curvature. The gravel bar creates a classic pool-riffle-pool sequence. Browns hold on the deep outside, rainbow holdovers work the riffle head. Wade the inside gravel bar for optimal casting position.' },
      { name: 'Cedar Broad Tailout', lat: 37.42944, lng: -91.61469, habitat: 'tailout', zoneId: 'cedar-grove', notes: 'Broad tailout as deep water shallows over gravel (node 354, 12515m). Classic evening emergence water — big browns push up from pools at dusk to feed on hatching BWOs, caddis, and midges. Remote backcountry location means minimal competition for prime lies. Stand downstream and cast up.' },
      { name: 'Lower Cedar Seam', lat: 37.42717, lng: -91.61497, habitat: 'seam', zoneId: 'cedar-grove', notes: 'Strong 90° seam in the lower Cedar Grove reach (node 359, 12774m). Converging current lines from an S-curve create a prime feeding lane. Fish hold in the slower water and intercept food washing through the seam. Tight-line nymphing or precisely-mended indicator rigs.' },
      { name: 'Switchback Pool', lat: 37.42552, lng: -91.61582, habitat: 'pool', zoneId: 'cedar-grove', notes: 'Deep 73° left-bend pool in the lower Cedar Grove (node 363, 12986m). Remote water with virtually no fishing pressure. Wild browns hold with minimal disturbance and feed confidently. Approach stealthily, use longer leaders. Fine tippets (5X-6X) and small patterns (sz 18-22 midges, BWOs).' },
      { name: 'Cedar South Pool', lat: 37.42174, lng: -91.61383, habitat: 'pool', zoneId: 'cedar-grove', notes: 'Deep 94° left-bend pool in the southernmost Cedar Grove reach (node 373, 13446m). One of the last major pools before the river leaves Blue Ribbon water. Trophy brown trout territory. Remote backcountry — gravel bar camping access. Streamers stripped through at dawn and dusk produce the biggest fish.' }
    ],
    ...
    streamPath: [
      ...
      [37.4482577,-91.6711337],[37.4477655,-91.6712702],[37.4470039,-91.6712555],[37.4466992,-91.6713736],
      [37.4464209,-91.6713477],[37.4462832,-91.6710968],[37.4461338,-91.6707057],[37.4459404,-91.6701116],
      [37.4456651,-91.6697168],[37.4453721,-91.6690674],[37.4451993,-91.668632],[37.4451524,-91.6682224],
      [37.4452432,-91.6679235],[37.4454688,-91.6673589],[37.4458203,-91.6669863],[37.4464297,-91.6660859],
      [37.4468925,-91.6653479],[37.4475282,-91.6646358],[37.4477333,-91.6645767],[37.4480262,-91.6643295],
      [37.4483719,-91.6637834],[37.4486619,-91.6635104],[37.4489695,-91.6633517],[37.4494148,-91.6630971],
      [37.4496198,-91.6629126],[37.4498952,-91.6626359],[37.4499567,-91.6623923],[37.4500983,-91.6621659],
      [37.4501823,-91.6618573],[37.4503983,-91.6615788],[37.4504342,-91.6615141],[37.4504538,-91.6614657],
