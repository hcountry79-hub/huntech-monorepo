...
window.TROUT_HOTSPOT_FLAVOR = {
  riffle: {
    ...
    lures: [
      '1/8oz Rooster Tail white — cast upstream, steady slow retrieve through the riffle. The blade flash imitates a fleeing baitfish.',
      '1/8oz Panther Martin gold — cold-water riffle specialist. The blade spins at slower speeds for sluggish trout.',
      'Trout Magnet white on 1/64oz jig — drift through the riffle like a natural insect. Zero retrieve, pure drift.',
      '1/16oz Rooster Tail — downsize for narrow riffles. Smaller profile, more natural in shallow water.',
      'Kastmaster gold 1/8oz — when riffles are too shallow for spinners, flutter a spoon through. Less snag risk.'
    ],
    bait: [
      'Nightcrawler half on #10 hook with split shot — drift through the riffle naturally. Current rolls the bait past feeding trout.',
      'PowerBait chartreuse on #12 treble with just enough weight for bottom contact. Riffles dislodge natural food — match it.',
      'Wax worms on #14 hook with single split shot — cold-water finesse in riffles. Small and natural.',
      'Single salmon egg on #12 egg hook — bright color visible in faster riffle water. No added weight needed.',
  ...
  pool: {
    ...
    lures: [
      ...
      'Kastmaster gold 1/8oz — lift-and-flutter technique. Lift rod tip, let the spoon flutter on slack line. Deadly in deep pools.',
      'Trout Magnet black on 1/64oz jig — high contrast on light gravel bottom. Drift through the pool head.',
      'Rapala ULM-04 rainbow trout — twitch and pause at pool depth. Big trout smash motionless twitched lures.',
      'Marabou jig white 1/32oz — drag slowly along the pool floor. Breathing marabou fibers trigger reflex strikes.'
    ],
    bait: [
      'PowerBait (condition-matched color) on #12 treble, sliding sinker rig. Deep pools are PowerBait paradise.',
      'Nightcrawler full on #8 hook on the bottom. The biggest pool trout prefer the biggest meal available.',
      'PowerBait Power Eggs (floating) on #14 single hook — eggs float just off bottom where trout cruise.',
      'Salmon eggs on #12 hook in clear pools — red/orange stands out against gravel. Natural profile.',
      'Berkley Mice Tails chartreuse on #10 hook — dual-density design moves in even the slightest pool current.'
    ]
  },
  run: {
    ...
    lures: [
      '1/8oz Rooster Tail white — quartering upstream cast, let it swing through the run. Classic spinner technique.',
      'Trout Magnet on 1/64oz jig — drift through runs like a natural insect. The most natural lure presentation possible.',
      '1/8oz Panther Martin gold — slow swing through runs in cold water. Blade turns at the lowest retrieve speeds.',
      'Kastmaster 1/8oz silver — flutter through the deeper end of runs. Lift-drop retrieve mimics wounded baitfish.',
      'Small inline spinner cast across the run — the downstream swing imitates a baitfish caught in current.'
    ],
    bait: [
      'Nightcrawler on #10 hook with split shot — drift through the run naturally. Crawlers tumble like real food in current.',
      'PowerBait on #12 treble under slip bobber — the bobber carries it through the entire run at the right depth.',
      'Corn on #10 hook drifted with single split shot — lightweight and natural. Rolls through like drift food.',
      'Wax worms on #14 hook — cold water finesse drifted through runs. Small natural profile, perfect in moderate current.',
      'PowerBait Power Eggs on #14 hook with micro shot — floating eggs ride just off bottom where trout search.'
    ]
  },
  boulder: {
    ...
    lures: [
      ...
      'Kastmaster gold 1/8oz — flutter into pockets. Tight wobble works in small water behind structure.',
      'Trout Magnet on 1/64oz jig — drop into each pocket. Tiny jig sinks into slack water where trout hold.',
      'Small crankbait (Rapala ULM-04) — twitched past structure. Pause in the eddy behind boulders.',
      'Marabou jig 1/32oz — drag along the bottom near structure. Breathing fibers trigger ambush response.'
    ],
    bait: [
      'Nightcrawler on #10 hook — drop into boulder pockets. The crawler sits on bottom and trout find it by scent.',
      'PowerBait (condition-matched color) — mold onto #12 treble, drop into slack water behind rocks.',
      'Wax worms on #14 hook — natural pocket water presentation. Small profile for tight quarters.',
      'Single salmon egg on #14 hook — drift through the pocket with no weight. Bright, visible, natural drift.',
      'Live cricket on #10 hook — cast tight to structure in summer. Struggling insect triggers immediate strikes.'
    ]
  },
  tailout: {
    ...
    lures: [
      'Trout Magnet white on 1/64oz — lightest lure option. Drifts naturally through thin tailout water.',
      '1/16oz Rooster Tail (downsize!) — smaller spinner for shallow tailout water. Retrieve barely fast enough for blade spin.',
      'Small spoon (1/16oz Phoebe) — flutters through thin water. Wide wobble visible even in shallows.',
    ...
    bait: [
      ...
      'PowerBait tiny ball on #14 hook — downsize from #12 in thin water. Trout inspect before biting.',
      ...
      'Mini marshmallow + PowerBait combo — floating presentation in thin tailout. Suspends at trout level.'
    ]
  }
};
